    ...
    public class WorldContextSeedData
    {
        ...
        public async Task EnsureSeedData()
        {
            ...
            {                
                ...
                //Add this trip to our context entity Trips - this doesn't actually add it to the database but just locally
                _context.Trips.Add(usTrip);
                _context.Stops.AddRange(usTrip.Stops);//Stops in usTrip is a collection of Stops. //So the this takes all the stops that make up our usTrip and adds it to the Stops table.
                ...
                //Now push the data we have stored to the database
